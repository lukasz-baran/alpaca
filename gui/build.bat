...
set all_modules=java.base,java.compiler,java.instrument,java.management.rmi,java.desktop,java.prefs,java.scripting,java.security.jgss,java.sql.rowset,jdk.net,javafx.graphics,javafx.fxml,javafx.controls
...
jpackage --type msi --dest output/installer --input input --name alpaca --main-class org.springframework.boot.loader.PropertiesLauncher --main-jar gui-1.0.0-SNAPSHOT.jar --runtime-image target/java-runtime --win-menu --win-shortcut --win-console
endlocal
@ECHO ON